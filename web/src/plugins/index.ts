...
export { PluginSlot, KNOWN_SLOT_NAMES, registerSlot, getSlotEntries, getConfigSectionNames, useConfigSectionNames, onSlotRegistered, unregisterPluginSlots } from "./slots";
